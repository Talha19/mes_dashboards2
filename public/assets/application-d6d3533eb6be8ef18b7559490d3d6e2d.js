...
$(function () {
  low_fps = $('#flot-chart-bar').data('lowfps');
...
$(function () {
	...
	var data = [
		{ label: "Series 0", data: 2 },
		{ label: "Series 1", data: 2 },
...
$(document).ready(function(){
	...
	function plot(){
		...
		sin.push([0, 3], [4, 5], [8, 7], [9, 10], [15, 13]);
		cos.push([0, 3], [4, 8], [8, 5], [9, 13]);
		...
		var plotObj = $.plot( $("#flot-chart-line"),
			[ { data: sin, label: "sin(x)"}, { data: cos, label: "x^2" } ],
			options );
	}
});
